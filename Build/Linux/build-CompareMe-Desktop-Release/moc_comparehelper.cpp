...
#include "../../../Releases/CompareMe/compare_me/CompareMe/Compareing/comparehelper.h"
...
struct qt_meta_stringdata_CompareHelper_t {
    QByteArrayData data[4];
    char stringdata[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_CompareHelper_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_CompareHelper_t qt_meta_stringdata_CompareHelper = {
    {
...
QT_MOC_LITERAL(3, 22, 7)
    ...
    "CompareHelper\0Update\0\0AFinish\0"
};
...
void CompareHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CompareHelper::*_t)(int , QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CompareHelper::Update)) {
                *result = 0;
            }
        }
        {
            typedef void (CompareHelper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CompareHelper::AFinish)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject CompareHelper::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CompareHelper.data,
      qt_meta_data_CompareHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CompareHelper.stringdata))
