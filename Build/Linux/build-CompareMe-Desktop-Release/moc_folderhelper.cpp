...
#include "../../../Releases/CompareMe/compare_me/CompareMe/Copy/Helper/folderhelper.h"
...
struct qt_meta_stringdata_FolderHelper_t {
    QByteArrayData data[4];
    char stringdata[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_FolderHelper_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_FolderHelper_t qt_meta_stringdata_FolderHelper = {
    {
...
QT_MOC_LITERAL(3, 21, 6)
    ...
    "FolderHelper\0Update\0\0Finish\0"
};
...
void FolderHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FolderHelper::*_t)(int , QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FolderHelper::Update)) {
                *result = 0;
            }
        }
        {
            typedef void (FolderHelper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FolderHelper::Finish)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject FolderHelper::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_FolderHelper.data,
      qt_meta_data_FolderHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FolderHelper.stringdata))
